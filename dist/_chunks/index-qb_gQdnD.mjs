...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-D9jQjX3h.mjs";
...
function ReactEditorJS(_a) {
  var { factory, holder: holder2, defaultValue, children, value, onInitialize } = _a, restProps = __rest(_a, ["factory", "holder", "defaultValue", "children", "value", "onInitialize"]);
  const memoizedHolder = React.useRef(holder2 !== null && holder2 !== void 0 ? holder2 : `react-editor-js-${Date.now().toString(16)}`);
...
const Editor = ({ onChange, name, value }) => {
  ...
  const handleInitialize = React.useCallback(async (instance) => {
    ...
    style.innerHTML = `
      .ce-block { font-size: 1.25rem !important; }
      h1.ce-header { font-size: 3rem !important; }
      h2.ce-header { font-size: 2.5rem !important; }
      h3.ce-header { font-size: 2rem !important; }
      h4.ce-header { font-size: 1.75rem !important; }
      h5.ce-header { font-size: 1.5rem !important; }
      h6.ce-header { font-size: 1.35rem !important; }
  `;
...
const Wysiwyg = ({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Box, null, /* @__PURE__ */ React.createElement(Typography, { variant: "pi", fontWeight: "bold" }, label), required && /* @__PURE__ */ React.createElement(Typography, { variant: "pi", fontWeight: "bold", textColor: "danger600" }, "*")),
    /* @__PURE__ */ React.createElement(
      Editor,
      {
        onChange,
...
//# sourceMappingURL=index-qb_gQdnD.mjs.map
