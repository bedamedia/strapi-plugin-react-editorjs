...
const index = require("./index-BqWqUYdC.js");
...
const PluginId = /* @__PURE__ */ index.getDefaultExportFromCjs(pluginId_1);
...
function ReactEditorJS(_a) {
  ...
  const memoizedHolder = React__default.default.useRef(holder2 !== null && holder2 !== void 0 ? holder2 : `react-editor-js-${Date.now().toString(16)}`);
...
class ClientEditorCore {
  constructor(_a) {
    ...
    this._editorJS = new EditorJS__default.default(Object.assign({ tools: extendTools }, config2));
  }
...
function ReactEditorJSClient(props) {
  const factory = React__default.default.useCallback((config2) => new ClientEditorCore(config2), []);
...
const Wysiwyg = ({
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    description2 && /* @__PURE__ */ React__default.default.createElement(designSystem.Typography, { variant: "pi" }, formatMessage(description2))
  );
};
