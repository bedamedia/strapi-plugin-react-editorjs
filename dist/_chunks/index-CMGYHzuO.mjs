...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-A0Wnrudr.mjs";
...
const Editor = ({ onChange, name, value }) => {
  ...
  const handleInitialize = React.useCallback(async (instance) => {
    ...
    console.log(instance["_editorJS"].configuration);
  }, []);
...
//# sourceMappingURL=index-CMGYHzuO.mjs.map
