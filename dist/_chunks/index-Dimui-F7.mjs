...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-AO_JIDK4.mjs";
...
const Editor = ({ onChange, name, value }) => {
  ...
  const handleInitialize = React.useCallback(async (instance) => {
    ...
    const e = instance["_editorJS"].isReady;
    console.log(e);
  }, []);
...
//# sourceMappingURL=index-Dimui-F7.mjs.map
