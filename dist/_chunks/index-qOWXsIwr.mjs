...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-D12taCvU.mjs";
...
const Editor = ({ onChange, name, value }) => {
  ...
  useEffect(() => {
    const changed = !lodashExports.isEqual(editorValueRef.current, value);
    console.log({ changed, isReady, shouldNotReRender: shouldReRender });
    if (isReady && !shouldReRender && changed) {
...
//# sourceMappingURL=index-qOWXsIwr.mjs.map
