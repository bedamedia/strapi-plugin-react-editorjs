...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-CjqhDcOU.mjs";
...
const Editor = ({ onChange, name, value }) => {
  ...
  const handleInitialize = React.useCallback(async (instance) => {
    ...
    const e = await instance["_editorJS"];
    console.log(e);
  }, []);
...
//# sourceMappingURL=index-oVUaYKCC.mjs.map
