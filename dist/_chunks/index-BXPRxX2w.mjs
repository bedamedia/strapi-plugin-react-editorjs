...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-InPPgCnS.mjs";
...
const Editor = ({ locale, onChange, name, value }) => {
  ...
  useEffect(() => {
    if (isReady) editorCore.current.render(getValue(value));
  }, [locale]);
...
//# sourceMappingURL=index-BXPRxX2w.mjs.map
