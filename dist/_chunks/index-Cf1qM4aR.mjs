...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-DGRAtrxA.mjs";
...
const Editor = ({ onChange, name, value }) => {
  ...
  const handleInitialize = React.useCallback(async (instance) => {
    ...
    const e = await instance["_editorJS"].isReady;
    console.log(e);
  }, []);
...
//# sourceMappingURL=index-Cf1qM4aR.mjs.map
