...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-B5Jgkfaw.mjs";
...
const Editor = ({ onChange, name, value }) => {
  ...
  const handleInitialize = React.useCallback(async (instance) => {
    ...
    document.getElementById(holder).style.color = "black";
    document.getElementById(holder).style.fontSize = "16px";
  }, []);
...
//# sourceMappingURL=index-CfaTLhHX.mjs.map
