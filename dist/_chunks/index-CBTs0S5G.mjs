...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-BGD67fFC.mjs";
...
const Editor = ({ onChange, name, value }) => {
  ...
  useEffect(() => {
    if (isReady && !shouldReRender && !lodashExports.isEqual(editorValueRef.current, value)) {
...
//# sourceMappingURL=index-CBTs0S5G.mjs.map
