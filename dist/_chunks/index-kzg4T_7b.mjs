...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, P as PluginId, a as axios } from "./index-CSmw5wQh.mjs";
...
const Editor = ({ onChange, name, value }) => {
  ...
  const handleInitialize = React.useCallback(async (instance) => {
    ...
    styleSheet.insertRule(
      ".ce-block { font-size: 20px !important; }",
...
//# sourceMappingURL=index-kzg4T_7b.mjs.map
